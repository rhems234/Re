    ...
    const fetchData = async () => {
      ...
      try {
        ...
        switch (query) {
          ...
          case "festival":
            response = await axios.get(
              "https://apis.data.go.kr/6260000/AttractionService/getAttractionKr?serviceKey=hhW7AMU4vwoVG1xBV%2FfnesXMaaMO77%2BHTacBdNBRMSzFaA8TV%2FCk2jSL2ffujNDwZGq5ddNhN%2BAc80WaWXc71A%3D%3D&numOfRows=10&pageNo=1&resultType=json"
            );
            console.log(response.data.getAttractionKr.item);
            setArticles(response.data.getAttractionKr.item);
            break;
          case "theme":
            response = await axios.get(
              "https://apis.data.go.kr/6260000/RecommendedService/getRecommendedKr?serviceKey=hhW7AMU4vwoVG1xBV%2FfnesXMaaMO77%2BHTacBdNBRMSzFaA8TV%2FCk2jSL2ffujNDwZGq5ddNhN%2BAc80WaWXc71A%3D%3D&numOfRows=10&pageNo=1&resultType=json"
            );
